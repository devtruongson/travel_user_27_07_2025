...
type Section =
    ...
    | {
          ...
          content: { intro: string; dishes: { name: string; image: string }[] };
      }
            ...
            <>
                ...
                >
                    <div className="flex items-center container m-auto justify-center absolute top-0 left-0 right-0 bottom-0 z-2 text-center">
                        ...
                        >
                            <h1
                                className={`${styles.mainTitle} font-[900] text-[160px]`}
                            >
                                {destination.name}
                            </h1>
                            <h3
                                className={`${styles.subTitle} font-[700] text-[100px]`}
                            >
                                Việt Nam
                            </h3>
                        </MotionFade>
                ...
                <ContentSection id="intro">
                    {/* INTRO */}
                    {(() => {
                        const section = getSection("intro") as
                            | { type: "intro"; title: string; content: string }
                            | undefined;
                        return (
                            section && (
                    ...
                    {/* HIGHLIGHT */}
                    {(() => {
                        const section = getSection("highlight") as
                            | {
                                  type: "highlight";
                                  content: {
                                      title: string;
                        ...
                        return (
                            section && (
                                <HighlightSection data={section.content} />
                            )
                        );
                    })()}
                    ...
                    {/* EXPERIENCE */}
                    {(() => {
                        const section = getSection("experience") as
                            | { type: "experience"; description: string }
                            | undefined;
                    ...
                    {/* GALLERY */}
                    {(() => {
                        const section = getSection("gallery") as
                            | { type: "gallery"; content: string[] }
                            | undefined;
                        return (
                            section && (
                                <GallerySection images={section.content} />
                            )
                        );
                    })()}
                    ...
                    {(() => {
                        ...
                        return (
                            section && (
                                <DelicaciesSection data={section.content} />
                            )
                        );
                    })()}
                    ...
                    {/* LAST IMAGE */}
                    {(() => {
                        const section = getSection("lastImage") as
                            | { type: "lastImage"; image: string }
                            | undefined;
                        return (
                            section && (
                                <EndingImage image={encodeURI(section.image)} />
                            )
                        );
                    })()}
                    {/* <RelatedSection /> */}
