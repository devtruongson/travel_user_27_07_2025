                ...
                <div className="flex-1 p-4">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <button
                            ...
                            className={`nav-button p-2 rounded-lg transition-all ${currentMonth === 0 && currentYear <= new Date().getFullYear()
                    ...
                    <div className="grid grid-cols-7 gap-1 mb-2">
                        {['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'].map((day, index) => (
                            <div
                                key={day}
                                className={`p-2 text-center text-sm font-medium ${index >= 5 ? 'text-red-500' : 'text-gray-700'
                                    }`}
                            >
                                {day}
                            </div>
                            ...
                            {calendarDays.map((day, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`calendar-day min-h-[80px] p-2 border border-gray-200 transition-all ${day.isSelected
                                            ? 'calendar-day selected'
                                            : hasDeparture
                        ...
                        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            {localSelectedDeparture.status === 'available' && (
                                <div className="mt-4 p-4 bg-white rounded-lg border border-blue-200">
                                    ...
                                    {
                                        !user && <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                            ...
                                            <div className="flex space-x-2">
                                                <button
                                                    ...
                                                    className={`px-4 py-2 text-sm rounded-lg transition-colors ${!isGuestBooking
