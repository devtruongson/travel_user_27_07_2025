...
export default function RegionTourLayout(props: TProps) {
    ...
    return (
        <div>
            <div
                className={`flex gap-10 ${isReverse ? "flex-row-reverse" : ""}`}
            >
                ...
                <div className="flex-1 flex flex-col justify-center">
                    <div>
                        <h4 className="uppercase text-[#636363] font-bold text-[18px] mb-2 ">
                            {subTitle}
                        </h4>
                        <h2 className="text-[var(--color-primary)] text-4xl font-[900] leading-[1.3]">
                            {title}
                        </h2>
                    </div>
