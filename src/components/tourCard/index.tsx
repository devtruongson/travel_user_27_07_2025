            ...
            <Link href={href}>
                {imgUrl ? (
                    <Image
                        ...
                        height={1000}
                        quality={100}
                        className="w-full h-full object-cover object-center transform transition-transform duration-500 ease-in-out will-change-transform delay-75 group-hover:scale-105"
                    />
                ) : null}
                ...
                <div className="absolute z-1 left-0 right-0 bottom-0 py-5 px-5 text-[#fff]">
                    ...
                    {isDestination ? (
                        <div>
                            <div className="name-card font-extrabold text-[24px] mb-3 leading-[1.1]">
                                <h3>{nameDestination}</h3>
                            </div>
                            <p
                                className="text-[1.1rem] mt-2 text-gray-300 mb-4"
                                style={{
                                    display: "-webkit-box",
                                    WebkitLineClamp: 2,
                        ...
                        <div className="font-extrabold text-[24px] mb-3 leading-[1.1] name-card">
                            <h3>{nameTour}</h3>
                        </div>
                    )}
                        ...
                        {!isDestination &&
                            ...
                            promotionPrice < originalPrice ? (
                                <div>
                                    ...
                                    <p className="font-medium line-through text-[1.25rem]">
                ...
                <div className="absolute top-5 right-5 flex flex-col gap-3">
                    {Array.from({ length: Math.ceil(rating) }, (_, i) => (
                        <FaStar
                            key={i}
                            className="text-yellow-400 text-[1rem]"
                        />
                    ))}
                </div>
            </Link>
