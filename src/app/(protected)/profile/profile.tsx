    ...
    return (
        <div>
            ...
            <section className="container relative pb-12 flex gap-10">
                ...
                <div>
                    <p className="py-8 text-5xl font-extrabold text-[#005a69]">
                        {user?.full_name}
                    </p>
                    <div className="grid grid-cols-2 gap-6">
                        {info.map((item, index) => (
                            ...
                            >
                                <span className="inline-block font-bold text-[20px]">
                                    {item.label}
                                </span>
                                <span className="inline-block font-bold text-[#616161] text-[20px]">
                                    {item.value}
                                </span>
                            </div>
                        ))}
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="w-[600px]">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Thực hiện thay đổi cho hồ sơ của bạn tại
                                        đây. Nhấp vào lưu khi bạn hoàn tất.
                                    </DialogDescription>
                                </DialogHeader>
