...
import { Banner, Intro } from "@/layouts/home-section";
...
export default function FavoritesPage() {
    ...
    return (
        ...
        <section className="container m-auto px-4 py-10 md:py-16 mt-[200px]">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-blue-800 mb-8">Tour yêu thích của bạn</h1>
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {favorites.map((f) => (
                        <TourCard
                            ...
                            promotionPrice={f.tour.discount_price ? parseFloat(f.tour.discount_price) : undefined}
